...
public class IndentorTypePOM {

	public IndentorTypePOM() {
		PageFactory.initElements(BaseClass.driver,this);

}
	  @FindBy(xpath="//a[@class='btn btn-primary font-weight-bolder']")
	   private WebElement New_IndentorType;
	   @FindBy(xpath="//input[@id='code']")
	   private WebElement IndentorType_Code;
	...
	public WebElement getNew_IndentorType() {
		return New_IndentorType;
	}
	public WebElement getIndentorType_Code() {
		return IndentorType_Code;
	}
