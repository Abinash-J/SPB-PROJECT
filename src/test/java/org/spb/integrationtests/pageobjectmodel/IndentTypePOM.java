...
public class IndentTypePOM {

	public IndentTypePOM() {
		PageFactory.initElements(BaseClass.driver,this);

}
	  @FindBy(xpath="//a[@class='btn btn-primary font-weight-bolder']")
	   private WebElement New_IndentType;
	   @FindBy(xpath="//input[@id='indenttype_code']")
	   private WebElement IndentType_Code;
	   @FindBy(xpath="//input[@id='indenttype_desc']")
	...
	public WebElement getNew_IndentType() {
		return New_IndentType;
	}
	public WebElement getIndentType_Code() {
		return IndentType_Code;
	}
