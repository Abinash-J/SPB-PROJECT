...
public class CustomerPOM {
	...
	//Indentor Master
	 ...
	 @FindBy(xpath="//input[@id='legacy_customer_code']")
	   private WebElement LegacyCustomerCode;
	 ...
	 @FindBy(xpath="//input[@id='customer_short_name']")
	   private WebElement CustomerShortName;
...
//error messages for all 
     ...
     @FindBy(xpath="//div[contains(text(),'Please enter Customer Code')]")
	   private WebElement CustomerCodeError;
	 
	 @FindBy(xpath="//div[contains(text(),'Please enter Customer Name')]")
	   private WebElement CustomerNameError;
	 
	 @FindBy(xpath="//div[contains(text(),'Please enter Legacy Customer Code')]")
	   private WebElement LegacyCustomerCodeError;
	 
	 @FindBy(xpath="//div[contains(text(),'Please enter Customer Short Name')]")
	   private WebElement CustomerShortNameError;
	...
	public WebElement getLegacyCustomerCode() {
	...
	public WebElement getCustomerShortName() {
	...
	public WebElement getCustomerCodeError() {
		return CustomerCodeError;
	}
	public WebElement getCustomerNameError() {
		return CustomerNameError;
	}
	public WebElement getLegacyCustomerCodeError() {
		return LegacyCustomerCodeError;
	}
	public WebElement getCustomerShortNameError() {
		return CustomerShortNameError;
	}
