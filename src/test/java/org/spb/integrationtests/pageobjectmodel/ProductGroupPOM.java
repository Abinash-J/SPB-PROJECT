...
public class ProductGroupPOM {
	
	
	public ProductGroupPOM() {
		PageFactory.initElements(BaseClass.driver,this);

}
	  @FindBy(xpath="//a[@class='btn btn-primary font-weight-bolder']")
	   private WebElement New_ProductGroup;
	   @FindBy(xpath="//input[@id='productgroup_code']")
	   private WebElement ProductGroup_Code;
	   @FindBy(xpath="//input[@id='productgroup_desc']")
	...
	public WebElement getNew_ProductGroup() {
		return New_ProductGroup;
	}
	public WebElement getProductgroup_Code() {
		return ProductGroup_Code;
	}
