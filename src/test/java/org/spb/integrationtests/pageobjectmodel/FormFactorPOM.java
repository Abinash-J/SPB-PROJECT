...
public class FormFactorPOM {

	public FormFactorPOM() {
		PageFactory.initElements(BaseClass.driver,this);

}
	
	  @FindBy(xpath="//a[@class='btn btn-primary font-weight-bolder']")
	   private WebElement New_FormFactor;
	   @FindBy(xpath="//input[@id='formfactor_code']")
	   private WebElement FormFactor_Code;
	   @FindBy(xpath="//input[@id='formfactor_desc']")
	...
	public WebElement getNew_FormFactor() {
		return New_FormFactor;
	}
	public WebElement getFormFactor_Code() {
		return FormFactor_Code;
	}
