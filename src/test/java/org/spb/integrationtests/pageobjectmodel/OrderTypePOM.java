...
public class OrderTypePOM {
	...
	public OrderTypePOM() {
	  ...
	  @FindBy(xpath="//a[@class='btn btn-primary font-weight-bolder']")
	   private WebElement New_OrderType;
	   @FindBy(xpath="//input[@id='type']")
	   private WebElement OrderType_Code;
	   @FindBy(xpath="//input[@id='des']")
	   private WebElement Description;
	   @FindBy(xpath="//input[@id='category']")
	   private WebElement OrderCategory;
	   
	   @FindBy(xpath="//select[@id='plant']")
	   private WebElement Plant_dropdown;
	...
	public WebElement getNew_OrderType() {
		return New_OrderType;
	}
	public WebElement getOrderType_Code() {
	...
	public WebElement getPlant_dropdown() {
		return Plant_dropdown;
	}
