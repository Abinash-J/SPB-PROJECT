...
public class CustomerTypePOM {

	
	public CustomerTypePOM() {
		PageFactory.initElements(BaseClass.driver,this);

}
	  @FindBy(xpath="//a[@class='btn btn-primary font-weight-bolder']")
	   private WebElement New_CustomerType;
	   @FindBy(xpath="//input[@id='code']")
	   private WebElement CustomerType_Code;
	...
	public WebElement getNew_CustomerType() {
		return New_CustomerType;
	}
	public WebElement getCustomerType_Code() {
