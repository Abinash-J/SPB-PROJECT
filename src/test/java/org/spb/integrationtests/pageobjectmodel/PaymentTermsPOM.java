...
public class PaymentTermsPOM {

	
	public PaymentTermsPOM() {
		PageFactory.initElements(BaseClass.driver,this);

}
	  @FindBy(xpath="//a[@class='btn btn-primary font-weight-bolder']")
	   private WebElement New_PaymentTerms;
	   @FindBy(xpath="//input[@id='code']")
	   private WebElement PaymentTerms_Code;
	...
	public WebElement getNew_PaymentTerms() {
		return New_PaymentTerms;
	}
	public WebElement getPaymentTerms_Code() {
		return PaymentTerms_Code;
	}
