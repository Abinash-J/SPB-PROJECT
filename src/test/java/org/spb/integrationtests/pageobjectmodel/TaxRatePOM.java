...
public class TaxRatePOM {
	...
	public TaxRatePOM() {
	  ...
	  @FindBy(xpath="//a[@class='btn btn-primary font-weight-bolder']")
	   private WebElement New_TaxRate;
	   @FindBy(xpath="//input[@id='code']")
	   private WebElement Tax_Code;
	...
	public WebElement getNew_TaxRate() {
		return New_TaxRate;
	}
	public WebElement getTax_Code() {
		return Tax_Code;
	}
	public WebElement getTax_Type() {
		return Tax_Type;
	}
	...
	public WebElement getEffectiveTo() {
		return EffectiveTo;
	}
