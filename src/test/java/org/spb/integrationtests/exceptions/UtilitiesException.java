...
public class UtilitiesException extends SPBBaseException {

  private static final long serialVersionUID = 2320797311444331914L;
  private ErrorDetails errorDetails;

  protected UtilitiesException(Builder b) {
    super(b);
    this.errorDetails = b.errorDetails();
  }

  /** @return {@link Builder} instance to construct a new {@link UtilitiesException}. */
  ...
  protected static class BuilderImpl extends SPBBaseException.BuilderImpl implements Builder {
    ...
    protected BuilderImpl(UtilitiesException ex) {
      super(ex);
    ...
    @Override
    public UtilitiesException build() {
      return new UtilitiesException(this);
    }
  }
}
